...
export class StuffService {
  ...
  getStuff() {
    this.http.get('http://localhost:3000/api/things').subscribe(
      (stuff: Thing[]) => {
        if (stuff) {
          this.stuff = stuff;
          this.emitStuff();
  ...
  getThingById(id: string) {
    return new Promise((resolve, reject) => {
      this.http.get('http://localhost:3000/api/things/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  createNewThing(thing: Thing) {
    return new Promise((resolve, reject) => {
      this.http.post('http://localhost:3000/api/things', thing).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  createNewThingWithFile(thing: Thing, image: File) {
    return new Promise((resolve, reject) => {
      ...
      this.http.post('http://localhost:3000/api/things', thingData).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyThing(id: string, thing: Thing) {
    return new Promise((resolve, reject) => {
      this.http.put('http://localhost:3000/api/things/' + id, thing).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  modifyThingWithFile(id: string, thing: Thing, image: File | string) {
    return new Promise((resolve, reject) => {
      ...
      this.http.put('http://localhost:3000/api/things/' + id, thingData).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
  ...
  deleteThing(id: string) {
    return new Promise((resolve, reject) => {
      this.http.delete('http://localhost:3000/api/things/' + id).subscribe(
        (response) => {
          resolve(response);
        },
        (error) => {
